# Qwen3-Omni `testmodel.py`

This folder uses `testmodel.py` to evaluate Daily-Omni QA items with Qwen3-Omni.
...
- `--enable_batch_mode`: enable vLLM batch inference.
- `--batch_size`: batch size for vLLM batch mode.
